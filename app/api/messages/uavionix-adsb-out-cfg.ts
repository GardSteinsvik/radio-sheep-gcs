...
export class UavionixAdsbOutCfg extends MAVLinkMessage {
	...
	public _message_fields: [string, string, boolean, number][] = [
		['ICAO', 'uint32_t', false, 0],
		['stallSpeed', 'uint16_t', false, 0],
		['callsign', 'char', false, 9],
		['emitterType', 'uint8_t', false, 0],
		['aircraftSize', 'uint8_t', false, 0],
		['gpsOffsetLat', 'uint8_t', false, 0],
		['gpsOffsetLon', 'uint8_t', false, 0],
		['rfSelect', 'uint8_t', false, 0],
	];
}
