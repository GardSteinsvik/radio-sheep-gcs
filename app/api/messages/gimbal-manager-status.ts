...
export class GimbalManagerStatus extends MAVLinkMessage {
	...
	public _message_fields: [string, string, boolean, number][] = [
		...
		['primary_control_sysid', 'uint8_t', false, 0],
		['primary_control_compid', 'uint8_t', false, 0],
		['secondary_control_sysid', 'uint8_t', false, 0],
		['secondary_control_compid', 'uint8_t', false, 0],
	];
}
